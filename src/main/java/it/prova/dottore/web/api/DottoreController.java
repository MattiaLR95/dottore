...
import it.prova.dottore.dto.DottorePazienteDTO;
...
import it.prova.dottore.web.api.exception.IdNullUpdateException;
...
public class DottoreController {
	...
	public DottorePazienteDTO impostaVisita(@RequestBody DottorePazienteDTO dottorePazienteDTO) {
		...
		Dottore dottore = new Dottore(dottorePazienteDTO.getCodiceDottore(),
				dottorePazienteDTO.getCodFiscalePazienteAttualmenteInVisita());
